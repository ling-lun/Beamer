...
\institute{Southern University of Science and Technology \\ Control Science and Engineering \\ Master Student}
\date{2025.9.1}
...
%           \psRotation{25}(-1.2,2.6){$\dot\psi$}
    ...
    \begin{minipage}{0.5\linewidth}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[height=.4\textheight]{\SustechLogo}
        \end{figure}
    \end{minipage}
\end{frame}
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.2\linewidth]{\SustechLogo}
        \caption{这个校徽就是矢量图}
    \end{figure}
\end{frame}
